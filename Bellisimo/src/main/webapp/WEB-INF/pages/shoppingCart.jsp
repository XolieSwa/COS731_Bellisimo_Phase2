...
<c:if test="${not empty cartForm and not empty cartForm.cartLines   }">
    <form:form method="POST" modelAttribute="cartForm"
            ...
            <div class="product-preview-container">
                <ul>
                    <li><img class="product-image"
                             src="${pageContext.request.contextPath}/images/product.jpg" />
                    </li>
        ...
        <a class="navi-item"
           href="${pageContext.request.contextPath}/productList">Add New</a>
        <a class="navi-item"
           href="${pageContext.request.contextPath}/shoppingCartCustomer">Finalize Order</a>
